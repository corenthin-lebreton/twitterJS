...
router.post('/twitterIPSSI/',middleware.isAuthentificated,dtoTweet.checkCreateTweet,controllersTweet.createTweets);
router.get('/twitterIPSSI',middleware.isAuthentificated,controllersTweet.getTweets);
